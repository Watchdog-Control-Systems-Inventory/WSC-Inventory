# WSC-Inventory
Inventory and 2-bin Kanban system for Watchdog Control Systems DRIPCONN builds

Updating QR Code Links & HTML Redirects
...
Open the file and replace the existing link with the new one.

3. Generate a New QR Code (Using QR Code Monkey)
